...
public class DNITests {
    ...
    @Test
    public void checksPatternDNI(){
        String[] invalidos = new String[]{"063X35HJL", "67A98RFAIH$", "06311570w"};
        for (String invalido: invalidos){
            dni = new DNI(invalido);
            Assertions.assertEquals(false, dni.validar());
        }
    ...
    @Test
    public void checksControlDigitDNI(){
        String[] invalidos = new String[]{"05197923F", "52392713N", "57124742T","35326527M","93436494R"};
        for (String invalido: invalidos){
            dni = new DNI(invalido);
            Assertions.assertEquals(false, dni.validar());
        }
